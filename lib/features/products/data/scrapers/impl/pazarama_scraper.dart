...
/// Pazarama-specific scraper for Turkish site
class PazaramaScraper extends BaseScraper {
  PazaramaScraper({http.Client? client}) : super(client: client);

  @override
  bool canHandle(Uri url) {
    return url.host.contains('pazarama.com');
  }
  ...
  Future<ScrapedProduct> scrape(Uri url) async {
    ...
    throw const ScraperException(
      'Could not extract product information from Pazarama page.',
  ...
  @override
  String get displayName => 'Pazarama Scraper';

  @override
  List<String> get supportedHosts => ['pazarama.com'];
}
