...
/// Rossmann-specific scraper for Turkish site
class RossmannScraper extends BaseScraper {
  RossmannScraper({http.Client? client}) : super(client: client);

  @override
  bool canHandle(Uri url) {
    return url.host.contains('rossmann.com.tr');
  }
  ...
  Future<ScrapedProduct> scrape(Uri url) async {
    ...
    throw const ScraperException(
      'Could not extract product information from Rossmann page.',
  ...
  @override
  String get displayName => 'Rossmann Scraper';

  @override
  List<String> get supportedHosts => ['rossmann.com.tr'];
}
