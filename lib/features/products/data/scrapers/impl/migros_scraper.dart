...
/// Migros-specific scraper for Turkish site
class MigrosScraper extends BaseScraper {
  MigrosScraper({http.Client? client}) : super(client: client);

  @override
  bool canHandle(Uri url) {
    return url.host.contains('migros.com.tr');
  }
  ...
  Future<ScrapedProduct> scrape(Uri url) async {
    ...
    throw const ScraperException(
      'Could not extract product information from Migros page.',
  ...
  @override
  String get displayName => 'Migros Scraper';

  @override
  List<String> get supportedHosts => ['migros.com.tr'];
}
