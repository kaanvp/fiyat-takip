...
/// Bershka-specific scraper for SPA site
class BershkaScraper extends BaseScraper {
  BershkaScraper({http.Client? client}) : super(client: client);

  @override
  bool canHandle(Uri url) {
    return url.host.contains('bershka.com');
  }
  ...
  Future<ScrapedProduct> scrape(Uri url) async {
    ...
    throw const ScraperException(
      'Could not extract product information from Bershka page.',
  ...
  ScrapedProduct? _findProductInMap(Map<dynamic, dynamic> map, Uri url) {
    try {
      ...
      String? foundImage;
      final imageKeys = ['image', 'imageUrl', 'images', 'media'];
  ...
  @override
  String get displayName => 'Bershka Scraper';

  @override
  List<String> get supportedHosts => ['bershka.com'];
}
