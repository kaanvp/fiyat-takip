...
/// MediaMarkt-specific scraper for Turkish site
class MediaMarktScraper extends BaseScraper {
  MediaMarktScraper({http.Client? client}) : super(client: client);

  @override
  bool canHandle(Uri url) {
    return url.host.contains('mediamarkt.com.tr');
  }
  ...
  Future<ScrapedProduct> scrape(Uri url) async {
    ...
    throw const ScraperException(
      'Could not extract product information from MediaMarkt page.',
  ...
  @override
  String get displayName => 'MediaMarkt Scraper';

  @override
  List<String> get supportedHosts => ['mediamarkt.com.tr'];
}
