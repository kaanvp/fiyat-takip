...
/// Boyner-specific scraper for Turkish site
class BoynerScraper extends BaseScraper {
  BoynerScraper({http.Client? client}) : super(client: client);

  @override
  bool canHandle(Uri url) {
    return url.host.contains('boyner.com.tr');
  }
  ...
  Future<ScrapedProduct> scrape(Uri url) async {
    ...
    throw const ScraperException(
      'Could not extract product information from Boyner page.',
  ...
  @override
  String get displayName => 'Boyner Scraper';

  @override
  List<String> get supportedHosts => ['boyner.com.tr'];
}
