...
/// Watsons-specific scraper for Turkish site
class WatsonsScraper extends BaseScraper {
  WatsonsScraper({http.Client? client}) : super(client: client);

  @override
  bool canHandle(Uri url) {
    return url.host.contains('watsons.com.tr');
  }
  ...
  Future<ScrapedProduct> scrape(Uri url) async {
    ...
    throw const ScraperException(
      'Could not extract product information from Watsons page.',
  ...
  @override
  String get displayName => 'Watsons Scraper';

  @override
  List<String> get supportedHosts => ['watsons.com.tr'];
}
