...
/// Pull&Bear-specific scraper for SPA site
class PullAndBearScraper extends BaseScraper {
  PullAndBearScraper({http.Client? client}) : super(client: client);

  @override
  bool canHandle(Uri url) {
    return url.host.contains('pullandbear.com');
  }
  ...
  Future<ScrapedProduct> scrape(Uri url) async {
    ...
    throw const ScraperException(
      'Could not extract product information from Pull&Bear page.',
  ...
  @override
  String get displayName => 'Pull&Bear Scraper';

  @override
  List<String> get supportedHosts => ['pullandbear.com'];
}
