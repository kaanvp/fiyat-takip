...
/// Flo-specific scraper for Turkish site
class FloScraper extends BaseScraper {
  FloScraper({http.Client? client}) : super(client: client);

  @override
  bool canHandle(Uri url) {
    return url.host.contains('flo.com.tr');
  }
  ...
  Future<ScrapedProduct> scrape(Uri url) async {
    ...
    throw const ScraperException(
      'Could not extract product information from Flo page.',
  ...
  @override
  String get displayName => 'Flo Scraper';

  @override
  List<String> get supportedHosts => ['flo.com.tr'];
}
