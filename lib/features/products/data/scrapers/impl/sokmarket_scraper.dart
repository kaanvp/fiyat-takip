...
/// SokMarket-specific scraper for Turkish site
class SokMarketScraper extends BaseScraper {
  SokMarketScraper({http.Client? client}) : super(client: client);

  @override
  bool canHandle(Uri url) {
    return url.host.contains('sokmarket.com.tr');
  }
  ...
  Future<ScrapedProduct> scrape(Uri url) async {
    ...
    throw const ScraperException(
      'Could not extract product information from SokMarket page.',
  ...
  (double, String)? _extractPrice(html_dom.Document document) {
    final selectors = [
      // CSS Module selectors (SokMarket uses CSS modules with hashed class names)
      '[class*="CPriceBox-module_discountedPrice__"]',
      '[class*="CPriceBox-module_price__"]',
      // Standard selectors
  ...
  @override
  String get displayName => 'SokMarket Scraper';

  @override
  List<String> get supportedHosts => ['sokmarket.com.tr'];
}
