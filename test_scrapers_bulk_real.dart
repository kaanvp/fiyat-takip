// Bulk scraper test with WebView/Puppeteer fallback
// This test uses the actual scraper registry with fallback logic

import 'package:fiyat_takip/core/providers/providers.dart';
...
void main() async {
  ...
  final registry = container.read(scraperRegistryProvider);
  ...
  for (int i = 0; i < urls.length; i++) {
    ...
    final scraper = registry.getScraperForUrl(uri);
    if (scraper == null) {
      print(red('❌  No scraper available'));
      fail++;
      continue;
    }
